...
import 'package:sa7ety/features/patient/search/widgets/item_tile.dart';
import 'package:sa7ety/features/patient/search/widgets/phone_tile.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyles.textSize24.copyWith(fontSize: 20),
                        ),
              ...
              const SizedBox(height: 10),
              Text(widget.doctorModel?.bio ?? '', style: TextStyles.textSize15),
              const SizedBox(height: 20),
              Container(
