  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: InkWell(
        onTap: () {
          if (isClickable) {
            pushTo(context, Routes.doctor_profile, extra: doctor);
          }
        },
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(doctor.specialization ?? '', style: TextStyles.textSize18),
                ],
              ),
            ),
            ...
            Row(
              ...
              children: [
                Text(doctor.rating.toString(), style: TextStyles.textSize18),
